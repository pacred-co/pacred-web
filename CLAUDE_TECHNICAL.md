...
| DB migrations | `supabase/migrations/` — through 0175 applied prod (0065 + 0168 are intentional gaps; 0173 = count_forwarder_by_owner RPC, 0174 = generate_member_code staff-skip, 0175 = receipt 50-ทวิ wht-cert gate; **next free = 0176**) |
