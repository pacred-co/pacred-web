...
|---|---|---|
| **`docs/research/poom-save-point-*.md`** | ภูม + Codex session ถัดไป | "JIRA comment" shape (full structured · TL;DR + commits + state) |
| **`docs/learnings/*.md`** | Codex agent ทุกตัวต่อไป | concept + cross-link · ไม่ใช่ exec-style |
...
| **commit message** | git log reader (Codex/human) | tight imperative · feature(scope): what + why |
