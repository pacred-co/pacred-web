...
> **Why this exists.** The user (เดฟ) said *"รีแฟคเตอร์ให้คนอ่านง่าย"*. Pacred has 4 humans + a rotation of Claude Code sessions reading every file every week. If a file is dense, every reader pays a tax. This skill is the systematic way to pay it down — without breaking what works.
