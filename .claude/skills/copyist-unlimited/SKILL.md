...
7. CAPTURE — record the input schema
   ...
   `.claude/skills/copyist-unlimited/inputs/<batch-name>.json` so the next
...
```typescript
/**
 * Scaffolded by .claude/skills/copyist-unlimited on 2026-05-15.
 * Source template: app/[locale]/(public)/customs-clearance-shipping-suvarnabhumi/page.tsx
 * Variant inputs:  .claude/skills/copyist-unlimited/inputs/phase-i-landings.json
 *
