...
export const GLOSSARY_DEFS = {
  ...
  /** เหมาๆ (PCSF flat fee). */
  mao_fee:
    "ค่าส่งเหมาๆ (PCSF) ฿100/ชิปเมนต์ — ค่าจัดส่งในไทยแบบเหมา คิดครั้งเดียวต่อชิปเมนต์ (ไม่ใช่ต่อกล่อง) · แก้ได้ถ้าลูกค้ามีหลายออเดอร์รอบเดียว",
  ...
  // ── กระเป๋าเงิน / wallet ─────────────────────────────────────────────
  /** wallet ติดลบ — the owner's example: not a bug. */
  wallet_negative:
    "กระเป๋าเงินติดลบ = ยอดยกมาจากระบบเก่า (เติม-แล้วจ่าย ไม่สมดุล) · รอบัญชีตรวจ/กระทบยอด — ไม่ใช่บัคของระบบ · ลูกค้าไม่ต้องจ่ายส่วนติดลบนี้",
} as const;
