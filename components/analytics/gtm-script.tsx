...
export function GtmScript() {
  ...
  return (
    <>
      {/* Hint the browser to open TLS to GTM + GA4 origins before the
          script tag begins downloading. Cheap (< 1 KB) but shaves ~100ms
          off the GTM-to-first-event window when traffic is cold. */}
