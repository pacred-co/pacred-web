...
const FAQS = [
  {
    ...
    a: "ค่าบริการขึ้นกับ 3 ปัจจัย: (1) ด่าน/ท่าที่สินค้าติดอยู่ (2) ประเภทสินค้า (ทั่วไป / มอก. / สินค้าควบคุม) และ (3) สถานะเอกสาร (ครบ / ไม่ครบ / HS Code มีปัญหา) เริ่มต้นเคสปกติ 2,800 บาท แจ้งราคาชัดเจนก่อนเริ่ม 100% ไม่มีค่าแอบแฝง",
  },
  {
  ...
  },
  {
    ...
    a: "งานปกติ เอกสารครบ: 1–3 ชม. ปล่อยสินค้าได้ภายในวัน. งานที่ต้องขอใบอนุญาตเพิ่ม (มอก./กสทช.): 1–5 วันทำการขึ้นกับหน่วยงาน. ทีมเราจะแจ้ง Timeline ที่แม่นยำหลังตรวจเอกสาร",
  },
  {
  ...
  },
  {
    ...
    a: "ครบทุกด่านในไทย: สุวรรณภูมิ · ดอนเมือง · Port กรุงเทพ (คลองเตย) · แหลมฉบัง · ICD ลาดกระบัง · ไปรษณีย์หลักสี่ · มุกดาหาร · หนองคาย · อรัญประเทศ · แม่สาย",
  },
];
