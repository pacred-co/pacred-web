...
export function PricingSection() {
  ...
  return (
    <section id="pricing" className="relative pt-1 md:pt-4 pb-7 md:pb-14">
      <div className="relative mx-auto w-full max-w-[1140px] px-[10px]">
        ...
        {/* ─── STEP 1 · Mode toggle (Cargo / Freight) ─── */}
        <div className="mx-auto mt-6 w-full max-w-[1120px]">
          <div className="flex items-center gap-1.5 text-[11px] md:text-[12px] font-bold text-muted uppercase tracking-[0.12em] mb-2">
            <span className="inline-flex items-center justify-center w-4 h-4 rounded-full bg-primary-600 text-white text-[9px] font-black">1</span>
            ประเภทบริการ
          </div>
        ...
        <div className="mx-auto mt-5 w-full max-w-[1120px]">
          <div className="flex items-center gap-1.5 text-[11px] md:text-[12px] font-bold text-muted uppercase tracking-[0.12em] mb-2">
            <span className="inline-flex items-center justify-center w-4 h-4 rounded-full bg-primary-600 text-white text-[9px] font-black">2</span>
            ประเทศต้นทาง
          </div>
        ...
        {/* ─── STEP 3 · Port picker (Freight only) ─── */}
        {mode === "freight" && (
          <div className="mx-auto mt-5 w-full max-w-[1120px]">
            <div className="flex items-center gap-1.5 text-[11px] md:text-[12px] font-bold text-muted uppercase tracking-[0.12em] mb-2">
              <span className="inline-flex items-center justify-center w-4 h-4 rounded-full bg-primary-600 text-white text-[9px] font-black">3</span>
        ...
        {/* ─── STEP (3 cargo / 4 freight) · Term toggle ─── */}
        <div className="mx-auto mt-5 w-full max-w-[1120px]">
          <div className="flex items-center gap-1.5 text-[11px] md:text-[12px] font-bold text-muted uppercase tracking-[0.12em] mb-2">
            <span className="inline-flex items-center justify-center w-4 h-4 rounded-full bg-primary-600 text-white text-[9px] font-black">{mode === "freight" ? 4 : 3}</span>
            Term การให้บริการ
          </div>
        ...
        {/* ─── Container type group header (Freight only) ─── */}
        {mode === "freight" && (
          <div className="mx-auto mt-6 w-full max-w-[1120px]">
            <div className="relative flex items-center gap-2 rounded-2xl overflow-hidden border border-border bg-gradient-to-r from-primary-50 via-white to-primary-50/40 dark:from-primary-950/30 dark:via-surface dark:to-primary-950/10 px-3.5 py-2.5">
              <span aria-hidden className="pointer-events-none absolute inset-y-0 -left-1/3 w-1/4 bg-gradient-to-r from-transparent via-primary-200/40 to-transparent dark:via-primary-700/20 animate-[shimmer_4.5s_infinite]" />
              <span className="inline-flex items-center justify-center w-4 h-4 rounded-full bg-primary-600 text-white text-[9px] font-black shrink-0">5</span>
              <span className="text-[11px] md:text-[12px] font-bold text-muted uppercase tracking-[0.12em]">ประเภทตู้</span>
              <span className="w-px h-4 bg-border" />
              <div className="flex items-center gap-1.5 flex-wrap">
                <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full bg-primary-600 text-white text-[10.5px] font-black tracking-wider">
                  <Ship className="w-3 h-3" strokeWidth={2.5} />
                  LCL
                  <span className="font-bold text-white/85">· ตู้รวม</span>
                </span>
                <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full bg-gradient-to-br from-amber-400 to-orange-500 text-white text-[10.5px] font-black tracking-wider">
                  <Warehouse className="w-3 h-3" strokeWidth={2.5} />
                  FCL
                  <span className="font-bold text-white/90">· ตู้เต็ม 20 / 40</span>
                </span>
              </div>
            </div>
          </div>
        ...
        <div className="mx-auto mt-4 md:mt-5 w-full max-w-[1120px]">
          {mode === "cargo" ? (
