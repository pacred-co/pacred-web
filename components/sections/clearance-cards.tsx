...
const SECTION_DESC  = "รวมบริการชิปปิ้งเคลียร์ของ เคลียร์สินค้านำเข้า เคลียร์สินค้าส่งออก เคลียร์เอกสารศุลกากร อย. มอก. ทั่วไป แบบครบจบในที่เดียว";
...
const CARDS: Card[] = [
  {
    ...
    note:  "เคลียร์ด่านสินค้าแอร์ สินค้าทั่วไป อย. มอก.",
    link:  LINE_URL,
  },
  {
    id: "laem-chabang",
