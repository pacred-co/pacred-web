...
const SCOPE: { icon: string; text: string }[] = [
  { icon: "/images/hero-section/icon-draf/transfast.png",       text: "มีโกดังรวมของที่ประเทศจีน อี้อู/กวางโจว" },
  ...
  { icon: "/images/hero-section/icon-draf/billingicon.png",     text: "ออกใบขนสินค้า ออกใบกำกับภาษี ลด ภาษีอากรฝั่งจีน 13%" },
    ...
    <section className="relative pt-1 md:pt-2 pb-1 md:pb-2">
      <div className="relative mx-auto w-full max-w-[1140px] px-4 md:px-5">
        <h1 className="text-[20px] md:text-[clamp(18px,2.2vw,28px)] md:whitespace-nowrap leading-[1.25] md:leading-[1.2] font-black tracking-[-0.025em] text-[#111827] dark:text-white">
          บริการนำเข้าสินค้าจีน-ไทย <span className="text-primary-600">(LCL) แชร์ตู้</span> รถ · เรือ · แอร์{" "}
          <span className="text-muted font-bold">|</span>{" "}
          <span className="text-primary-600 whitespace-nowrap">Pacred Shipping</span>
        </h1>
 ...
 */
export function LclScopeBullets() {
  return (
