...
export function RelatedTagsTabs({ groups }: { groups: TagGroup[] }) {
  ...
  return (
    <div>
      {/* Tabs — pill buttons, scrollable on mobile */}
        ...
        {groups.map((g, i) => {
          ...
          return (
            <button
              ...
              className={
                "inline-flex items-center px-3 md:px-4 h-8 md:h-10 rounded-lg text-[12.5px] md:text-[14px] font-bold tracking-tight transition-all duration-200 " +
                (isActive
