...
>
> **🔴 OWNER ACTION ITEMS (carryover):** promote dave-pacred → main when ready · Wave 3 payroll (salary data) · Wave 4 GOGO/JMF creds · the go-live flips (`commission.freight_enabled` · `tax_invoice.shop_yuan_enabled` · roles · `RECEIPT_TOKEN_SECRET` in Vercel) · test-customer/admin login (unblocks §0c authed-click-test).
