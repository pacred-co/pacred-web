...
>
> **WAVE PROGRESS:** ✅ W1 (money-safety) · ✅ W2a (yuan cost + badges + zip-lib · WHT false-positive) · ✅ W3.1 (notPortage combine-shipping) · ✅ W3.2 (shop print-flag) · ✅ W3.3 (manual dedup+auto-price) · ✅ W5 (migration 0183). **NEXT (in-code · "แยกร่าง" OK):** W4 cnt-hs cost-correction (P0 · big) · W6 JMF/TTP read-only + GOGO retire-banner (P1) · W3.4 per-fStatus tab strip (P1) · W7 polish · ON CONFLICT create-path UX. Per-wave status in `docs/research/forwarder-fidelity-audit-2026-06-14.md`.
>
