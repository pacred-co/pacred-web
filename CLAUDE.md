...
>
> **WAVE PROGRESS:** ✅ W1 (money-safety) · ✅ W2a (yuan cost + badges + zip-lib · WHT false-positive) · ✅ W3.1 (notPortage combine-shipping) · ✅ W3.2 (shop print-flag) · ✅ W3.3 (manual dedup+auto-price) · ✅ W4 (cnt-hs paid-container cost editor `7b8e6172`) · ✅ W5 (migration 0183 prod+dev). **IN PROGRESS:** W6 (JMF/TTP read-only + GOGO retire-banner · background agent · "แยกร่าง"). **NEXT:** W3.4 per-fStatus tab strip (P1) · W7 polish · ON CONFLICT create-path UX (UNIQUE already makes double-pay impossible). dave-pacred = main = `7b8e6172`. Per-wave status in `docs/research/forwarder-fidelity-audit-2026-06-14.md`.
>
