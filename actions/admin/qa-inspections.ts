...
// ════════════════════════════════════════════════════════════════
// Zod schemas — co-located in this file (same convention as
// actions/admin/cnt-payment.ts L57-62) because lib/validators/
// qa-inspection.ts still holds the legacy V-E10 schema (used by
// lib/validators/qa-inspection.test.ts). Inlining keeps the legacy
// tests passing while we ship the rebuilt module.
// ════════════════════════════════════════════════════════════════
