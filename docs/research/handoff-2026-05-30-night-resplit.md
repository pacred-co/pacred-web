...
10. **P1-5 — `tb_user_sales` earn-trigger.** ⚠️ **WAIT on เดฟ's commission architecture decision (§4 handshake B → ADR-0019 D-B says Path A faithful — earn-trigger spec ready · ภูม can build whenever).**
