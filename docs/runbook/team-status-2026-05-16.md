...
> **Last updated:** 2026-05-16 evening-14 (เดฟ via Claude) — **6 local commits ahead** (hold-push mode). validator tests +397 assertions · ADR-0014 lock · tax-invoice lib scaffold · `actions/tax-invoice.ts::requestTaxInvoice` skeleton + admin notify templates. ภูม T-P4 G2b customer-side action ready to run once migration 0034 applies on dev.
