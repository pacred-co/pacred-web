...
| **T-P4** | G2 tax invoice issuance per ADR-0006 — phases G2a-G2f | 14-19h | 🟡 **G2a ✅ + G2b ✅** — schema (เดฟ `f2230ed`) + customer request flow (this batch). G2c admin issue/PDF · G2d /api/tax-invoice/[id].pdf · G2e cancellation/credit-note · G2f audit+test remain |
