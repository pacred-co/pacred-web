...
> Source: `app/[locale]/(admin)/admin/page.tsx` · Group: `(admin)`
...
- ตรวจข้อมูลที่ดึงจาก DB แสดงครบ (ไม่ใช่ ฿0/ว่างทั้งที่ควรมีข้อมูล) — table: `admins`, `sales_payouts`, `tb_forwarder`, `tb_header_order`, `tb_payment`, `tb_settings`, `tb_users`, `tb_wallet`, `tb_wallet_hs`
