# Test Cases — `/admin/reports/cockpit`

**Cockpit ผู้บริหาร (AR/funnel)**

> Source: `app/[locale]/(admin)/admin/reports/cockpit/page.tsx` · Group: `(admin)`
...
- ตรวจข้อมูลที่ดึงจาก DB แสดงครบ (ไม่ใช่ ฿0/ว่างทั้งที่ควรมีข้อมูล) — table: `admins`, `tb_forwarder`, `tb_users`, `tb_wallet`
