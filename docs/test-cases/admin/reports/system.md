# Test Cases — `/admin/reports/system`

**รายงานระบบ**

> Source: `app/[locale]/(admin)/admin/reports/system/page.tsx` · Group: `(admin)`
...
- ตรวจข้อมูลที่ดึงจาก DB แสดงครบ (ไม่ใช่ ฿0/ว่างทั้งที่ควรมีข้อมูล) — table: `admins`, `tb_page_name`, `tb_web_hs`
