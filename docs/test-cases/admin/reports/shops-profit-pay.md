# Test Cases — `/admin/reports/shops-profit-pay`

**กำไร/จ่ายร้านค้า**

> Source: `app/[locale]/(admin)/admin/reports/shops-profit-pay/page.tsx` · Group: `(admin)`
...
- แสดง component หลัก: `csv-button`, `page-top-menubar`
- ตรวจข้อมูลที่ดึงจาก DB แสดงครบ (ไม่ใช่ ฿0/ว่างทั้งที่ควรมีข้อมูล) — table: `admins`, `tb_header_order`, `tb_users`, `tb_wallet_hs`
