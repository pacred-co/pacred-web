# Test Cases — `/admin/reports/sales-by-rep`

**ยอดขายแยกตามเซล**

> Source: `app/[locale]/(admin)/admin/reports/sales-by-rep/page.tsx` · Group: `(admin)`
...
- ตรวจข้อมูลที่ดึงจาก DB แสดงครบ (ไม่ใช่ ฿0/ว่างทั้งที่ควรมีข้อมูล) — table: `admins`, `vw_sales_by_rep`
