# Test Cases — `/admin/reports/search-demand`

**ดีมานด์การค้นหาสินค้า**

> Source: `app/[locale]/(admin)/admin/reports/search-demand/page.tsx` · Group: `(admin)`
...
- ตรวจข้อมูลที่ดึงจาก DB แสดงครบ (ไม่ใช่ ฿0/ว่างทั้งที่ควรมีข้อมูล) — table: `admins`, `tb_search_history`, `tb_sms_hs`
