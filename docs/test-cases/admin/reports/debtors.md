# Test Cases — `/admin/reports/debtors`

**ลูกหนี้ค้างชำระ**

> Source: `app/[locale]/(admin)/admin/reports/debtors/page.tsx` · Group: `(admin)`
...
- ตรวจข้อมูลที่ดึงจาก DB แสดงครบ (ไม่ใช่ ฿0/ว่างทั้งที่ควรมีข้อมูล) — table: `admins`, `tb_cash_back`, `tb_users`, `tb_wallet`
