# Test Cases — `/admin/reports/shop`

**รายงานฝั่งร้านค้า**

> Source: `app/[locale]/(admin)/admin/reports/shop/page.tsx` · Group: `(admin)`
...
- ตรวจข้อมูลที่ดึงจาก DB แสดงครบ (ไม่ใช่ ฿0/ว่างทั้งที่ควรมีข้อมูล) — table: `admins`, `tb_header_order`, `tb_order`, `tb_users`
