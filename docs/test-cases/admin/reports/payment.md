# Test Cases — `/admin/reports/payment`

**รายงานการชำระ**

> Source: `app/[locale]/(admin)/admin/reports/payment/page.tsx` · Group: `(admin)`
...
- ตรวจข้อมูลที่ดึงจาก DB แสดงครบ (ไม่ใช่ ฿0/ว่างทั้งที่ควรมีข้อมูล) — table: `admins`, `tb_payment`, `tb_users`
