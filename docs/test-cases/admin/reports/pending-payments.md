# Test Cases — `/admin/reports/pending-payments`

**รายการรอชำระ**

> Source: `app/[locale]/(admin)/admin/reports/pending-payments/page.tsx` · Group: `(admin)`
...
- ตรวจข้อมูลที่ดึงจาก DB แสดงครบ (ไม่ใช่ ฿0/ว่างทั้งที่ควรมีข้อมูล) — table: `admins`, `tb_users`, `tb_wallet_hs`
