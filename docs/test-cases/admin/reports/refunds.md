# Test Cases — `/admin/reports/refunds`

**รายงานคืนเงิน**

> Source: `app/[locale]/(admin)/admin/reports/refunds/page.tsx` · Group: `(admin)`
...
- ตรวจข้อมูลที่ดึงจาก DB แสดงครบ (ไม่ใช่ ฿0/ว่างทั้งที่ควรมีข้อมูล) — table: `admins`, `tb_forwarder`, `tb_users`, `tb_wallet_hs`
