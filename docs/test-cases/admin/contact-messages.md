# Test Cases — `/admin/contact-messages`

**ข้อความติดต่อจากหน้าเว็บ**

> Source: `app/[locale]/(admin)/admin/contact-messages/page.tsx` · Group: `(admin)`
...
- ตรวจข้อมูลที่ดึงจาก DB แสดงครบ (ไม่ใช่ ฿0/ว่างทั้งที่ควรมีข้อมูล) — table: `contact_messages`, `work_items`

**ผลทดสอบ:**  `[ ] ✅ ผ่าน`   `[ ] ❌ ไม่ผ่าน`   `[ ] 🔧 ต้องแก้/ไม่ถูกต้อง`   `[ ] ⏭ ข้าม`

**หมายเหตุ / บั๊กที่เจอ:** _______________________________________________

### TC-04 · Feature — `adminUpdateContactStatus()`

**Action:** `actions/admin/contact-messages` → `adminUpdateContactStatus`
