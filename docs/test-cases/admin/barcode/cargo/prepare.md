# Test Cases — `/admin/barcode/cargo/prepare`

**บาร์โค้ด cargo — เตรียมส่ง**

> Source: `app/[locale]/(admin)/admin/barcode/cargo/prepare/page.tsx` · Group: `(admin)`
...
- แสดง component หลัก: `camera-scanner`, `top-menu-barcode`
