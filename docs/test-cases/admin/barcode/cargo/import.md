# Test Cases — `/admin/barcode/cargo/import`

**บาร์โค้ด cargo — นำเข้า**

> Source: `app/[locale]/(admin)/admin/barcode/cargo/import/page.tsx` · Group: `(admin)`
...
- แสดง component หลัก: `top-menu-barcode`, `camera-scanner`
