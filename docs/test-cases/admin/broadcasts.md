# Test Cases — `/admin/broadcasts`

**แคมเปญ broadcast**

> Source: `app/[locale]/(admin)/admin/broadcasts/page.tsx` · Group: `(admin)`
...
- ตรวจข้อมูลที่ดึงจาก DB แสดงครบ (ไม่ใช่ ฿0/ว่างทั้งที่ควรมีข้อมูล) — table: `admins`, `tb_notify`
