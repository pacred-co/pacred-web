# Test Cases — `/admin/payment-reconciliation`

**กระทบยอดการชำระ**

> Source: `app/[locale]/(admin)/admin/payment-reconciliation/page.tsx` · Group: `(admin)`
...
### TC-05 · Feature — `manualMatch()`

**Action:** `actions/admin/payment-reconciliation` → `manualMatch`
...
### TC-06 · Feature — `markUnmatched()`

**Action:** `actions/admin/payment-reconciliation` → `markUnmatched`
