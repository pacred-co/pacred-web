# Test Cases — `/admin/commissions/tiers`

**ตั้งค่าขั้นคอมมิชชัน**

> Source: `app/[locale]/(admin)/admin/commissions/tiers/page.tsx` · Group: `(admin)`
...
### TC-05 · Feature — `adminUpsertCommissionTier()`

**Action:** `actions/admin/commissions` → `adminUpsertCommissionTier`
