# Test Cases — `/admin/report-cnt`

**รายงานตู้ (per-container)**

> Source: `app/[locale]/(admin)/admin/report-cnt/page.tsx` · Group: `(admin)`
...
- ตรวจข้อมูลที่ดึงจาก DB แสดงครบ (ไม่ใช่ ฿0/ว่างทั้งที่ควรมีข้อมูล) — table: `admins`, `tb_cnt_item`, `tb_forwarder`
