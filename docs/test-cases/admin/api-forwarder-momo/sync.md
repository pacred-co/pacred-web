# Test Cases — `/admin/api-forwarder-momo/sync`

**sync ข้อมูล MOMO (พรีวิว/ดึง)**

> Source: `app/[locale]/(admin)/admin/api-forwarder-momo/sync/page.tsx` · Group: `(admin)`
...
- ตรวจข้อมูลที่ดึงจาก DB แสดงครบ (ไม่ใช่ ฿0/ว่างทั้งที่ควรมีข้อมูล) — table: `admins`, `momo_container_closed`, `momo_import_tracks`, `momo_sack_infos`
