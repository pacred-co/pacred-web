# Test Cases — `/admin/wallet`

**จัดการกระเป๋าเงินลูกค้า (admin)**

> Source: `app/[locale]/(admin)/admin/wallet/page.tsx` · Group: `(admin)`
...
- ตรวจข้อมูลที่ดึงจาก DB แสดงครบ (ไม่ใช่ ฿0/ว่างทั้งที่ควรมีข้อมูล) — table: `admins`, `tb_cash_back`, `tb_users`, `tb_wallet`, `tb_wallet_hs`
