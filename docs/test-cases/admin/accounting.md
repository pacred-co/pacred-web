# Test Cases — `/admin/accounting`

**ศูนย์บัญชี (hub)**

> Source: `app/[locale]/(admin)/admin/accounting/page.tsx` · Group: `(admin)`
...
- แสดง component หลัก: `date-filter`, `csv-button`, `page-top-menubar`, `accounting-segment-pills`
- ตรวจข้อมูลที่ดึงจาก DB แสดงครบ (ไม่ใช่ ฿0/ว่างทั้งที่ควรมีข้อมูล) — table: `admins`, `tb_forwarder`, `tb_header_order`, `tb_payment`, `tb_users`, `tb_wallet_hs`
