# Test Cases — `/admin/cnt-hs`

**เบิกเงินค่าตู้ (cnt-hs)**

> Source: `app/[locale]/(admin)/admin/cnt-hs/page.tsx` · Group: `(admin)`
...
- ตรวจข้อมูลที่ดึงจาก DB แสดงครบ (ไม่ใช่ ฿0/ว่างทั้งที่ควรมีข้อมูล) — table: `admins`, `tb_cnt`, `tb_cnt_item`
