# Test Cases — `/admin/team-leaders`

**หัวหน้าทีม**

> Source: `app/[locale]/(admin)/admin/team-leaders/page.tsx` · Group: `(admin)`
...
- ตรวจข้อมูลที่ดึงจาก DB แสดงครบ (ไม่ใช่ ฿0/ว่างทั้งที่ควรมีข้อมูล) — table: `admins`, `customer_groups`, `profiles`, `team_leaders`

**ผลทดสอบ:**  `[ ] ✅ ผ่าน`   `[ ] ❌ ไม่ผ่าน`   `[ ] 🔧 ต้องแก้/ไม่ถูกต้อง`   `[ ] ⏭ ข้าม`

**หมายเหตุ / บั๊กที่เจอ:** _______________________________________________

### TC-05 · Feature — `adminCreateTeamLeader()`

**Action:** `actions/admin/team-leaders` → `adminCreateTeamLeader`
...
### TC-06 · Feature — `adminToggleTeamLeader()`

**Action:** `actions/admin/team-leaders` → `adminToggleTeamLeader`
...
### TC-07 · Feature — `adminUpdateTeamLeaderPct()`

**Action:** `actions/admin/team-leaders` → `adminUpdateTeamLeaderPct`
