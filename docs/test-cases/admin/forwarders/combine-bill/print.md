# Test Cases — `/admin/forwarders/combine-bill/print`

**พิมพ์ใบส่งสินค้า (บิลรวม)**

> Source: `app/[locale]/(admin)/admin/forwarders/combine-bill/print/page.tsx` · Group: `(admin)`
...
- ตรวจข้อมูลที่ดึงจาก DB แสดงครบ (ไม่ใช่ ฿0/ว่างทั้งที่ควรมีข้อมูล) — table: `admins`, `tb_forwarder`, `tb_users`
