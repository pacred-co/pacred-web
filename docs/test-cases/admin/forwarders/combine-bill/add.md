# Test Cases — `/admin/forwarders/combine-bill/add`

**สร้างบิลรวมใหม่**

> Source: `app/[locale]/(admin)/admin/forwarders/combine-bill/add/page.tsx` · Group: `(admin)`
...
**สังเกตเพิ่ม:** อาจ navigate → `/admin/forwarders/combine-bill` · ส่งค่าว่าง/ผิด → error `invalid_input` (Zod) แสดง inline ไม่ submit
