# Test Cases — `/admin/forwarders/combine-bill`

**รวมบิลส่งสินค้า**

> Source: `app/[locale]/(admin)/admin/forwarders/combine-bill/page.tsx` · Group: `(admin)`
...
### TC-05 · Feature — `adminCreateCombineBill()`

**Action:** `actions/admin/combine-bill` → `adminCreateCombineBill`
