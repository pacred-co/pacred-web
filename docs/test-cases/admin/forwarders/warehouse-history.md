# Test Cases — `/admin/forwarders/warehouse-history`

**ประวัติเข้าโกดัง**

> Source: `app/[locale]/(admin)/admin/forwarders/warehouse-history/page.tsx` · Group: `(admin)`
...
- ตรวจข้อมูลที่ดึงจาก DB แสดงครบ (ไม่ใช่ ฿0/ว่างทั้งที่ควรมีข้อมูล) — table: `admins`, `tb_admin`, `tb_forwarder`, `tb_forwarder_import2`, `tb_users`

**ผลทดสอบ:**  `[ ] ✅ ผ่าน`   `[ ] ❌ ไม่ผ่าน`   `[ ] 🔧 ต้องแก้/ไม่ถูกต้อง`   `[ ] ⏭ ข้าม`

**หมายเหตุ / บั๊กที่เจอ:** _______________________________________________

### TC-05 · Feature — `adminDeleteScan()`

**Action:** `actions/admin/warehouse-history` → `adminDeleteScan`
