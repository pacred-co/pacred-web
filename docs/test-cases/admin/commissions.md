# Test Cases — `/admin/commissions`

**คอมมิชชัน (admin · live tb_user_sales)**

> Source: `app/[locale]/(admin)/admin/commissions/page.tsx` · Group: `(admin)`
...
- ตรวจข้อมูลที่ดึงจาก DB แสดงครบ (ไม่ใช่ ฿0/ว่างทั้งที่ควรมีข้อมูล) — table: `admins`, `tb_forwarder`, `tb_user_sales`, `tb_user_sales_admin_pay`
