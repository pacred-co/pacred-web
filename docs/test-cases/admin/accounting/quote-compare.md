# Test Cases — `/admin/accounting/quote-compare`

**เครื่องมือเทียบราคา (CEO pricing)**

> Source: `app/[locale]/(admin)/admin/accounting/quote-compare/page.tsx` · Group: `(admin)`
...
- ตรวจข้อมูลที่ดึงจาก DB แสดงครบ (ไม่ใช่ ฿0/ว่างทั้งที่ควรมีข้อมูล) — table: `admins`, `tb_rate_custom_cbm`, `tb_settings`, `tb_users`
