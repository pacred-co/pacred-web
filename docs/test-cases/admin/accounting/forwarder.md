# Test Cases — `/admin/accounting/forwarder`

**บัญชีออเดอร์นำเข้า**

> Source: `app/[locale]/(admin)/admin/accounting/forwarder/page.tsx` · Group: `(admin)`
...
- ตรวจข้อมูลที่ดึงจาก DB แสดงครบ (ไม่ใช่ ฿0/ว่างทั้งที่ควรมีข้อมูล) — table: `admins`, `tb_cash_back_hs`, `tb_corporate`, `tb_forwarder`, `tb_receipt_item`, `tb_users`, `tb_wallet_hs`
