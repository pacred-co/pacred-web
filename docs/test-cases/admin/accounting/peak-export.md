# Test Cases — `/admin/accounting/peak-export`

**ส่งออกข้อมูลเข้า PEAK**

> Source: `app/[locale]/(admin)/admin/accounting/peak-export/page.tsx` · Group: `(admin)`
...
- ตรวจข้อมูลที่ดึงจาก DB แสดงครบ (ไม่ใช่ ฿0/ว่างทั้งที่ควรมีข้อมูล) — table: `admins`, `tb_bill`, `tb_bill_item`, `tb_receipt`, `tb_users`
