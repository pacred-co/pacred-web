# Test Cases — `/admin/accounting/freight`

**บัญชี freight**

> Source: `app/[locale]/(admin)/admin/accounting/freight/page.tsx` · Group: `(admin)`
...
- แสดง component หลัก: `page-top-menubar`, `accounting-segment-pills`
