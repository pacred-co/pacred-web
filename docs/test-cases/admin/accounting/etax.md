# Test Cases — `/admin/accounting/etax`

**e-Tax (ออก XML ภาษีอิเล็กทรอนิกส์)**

> Source: `app/[locale]/(admin)/admin/accounting/etax/page.tsx` · Group: `(admin)`
...
- ตรวจข้อมูลที่ดึงจาก DB แสดงครบ (ไม่ใช่ ฿0/ว่างทั้งที่ควรมีข้อมูล) — table: `admins`, `tb_forwarder_tax_invoice`
