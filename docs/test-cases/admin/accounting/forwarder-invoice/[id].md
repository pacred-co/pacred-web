# Test Cases — `/admin/accounting/forwarder-invoice/[id]`

**รายละเอียดใบแจ้งหนี้นำเข้า**

> Source: `app/[locale]/(admin)/admin/accounting/forwarder-invoice/[id]/page.tsx` · Group: `(admin)`
...
- ตรวจข้อมูลที่ดึงจาก DB แสดงครบ (ไม่ใช่ ฿0/ว่างทั้งที่ควรมีข้อมูล) — table: `admins`, `tb_address`, `tb_address_main`, `tb_corporate`, `tb_forwarder`, `tb_receipt`, `tb_receipt_item`, `tb_users`
