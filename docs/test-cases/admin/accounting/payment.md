# Test Cases — `/admin/accounting/payment`

**บัญชีรายการชำระ**

> Source: `app/[locale]/(admin)/admin/accounting/payment/page.tsx` · Group: `(admin)`
...
- ตรวจข้อมูลที่ดึงจาก DB แสดงครบ (ไม่ใช่ ฿0/ว่างทั้งที่ควรมีข้อมูล) — table: `admins`, `tb_payment`, `tb_users`, `tb_wallet_hs`
