# Test Cases — `/admin/accounting/documents`

**เอกสารบัญชี (PEAK hub)**

> Source: `app/[locale]/(admin)/admin/accounting/documents/page.tsx` · Group: `(admin)`
...
- ตรวจข้อมูลที่ดึงจาก DB แสดงครบ (ไม่ใช่ ฿0/ว่างทั้งที่ควรมีข้อมูล) — table: `admins`, `tax_invoices`, `tb_bill`, `tb_receipt`
