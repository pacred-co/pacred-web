# Test Cases — `/admin/accounting/closing`

**ปิดงวดบัญชี**

> Source: `app/[locale]/(admin)/admin/accounting/closing/page.tsx` · Group: `(admin)`
...
- ตรวจข้อมูลที่ดึงจาก DB แสดงครบ (ไม่ใช่ ฿0/ว่างทั้งที่ควรมีข้อมูล) — table: `admins`, `tb_receipt`, `tb_users`
