# Test Cases — `/admin/accounting/margin-monitor`

**มอนิเตอร์กำไรขั้นต้น (CEO ≤15k/ตู้)**

> Source: `app/[locale]/(admin)/admin/accounting/margin-monitor/page.tsx` · Group: `(admin)`
...
- ตรวจข้อมูลที่ดึงจาก DB แสดงครบ (ไม่ใช่ ฿0/ว่างทั้งที่ควรมีข้อมูล) — table: `admins`, `tb_forwarder`, `tb_sales_report`
