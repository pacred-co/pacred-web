# Test Cases — `/admin/tax-invoices`

**ใบกำกับภาษี (รายการ)**

> Source: `app/[locale]/(admin)/admin/tax-invoices/page.tsx` · Group: `(admin)`
...
- ตรวจข้อมูลที่ดึงจาก DB แสดงครบ (ไม่ใช่ ฿0/ว่างทั้งที่ควรมีข้อมูล) — table: `admins`, `tax_invoices`
