# Test Cases — `/admin/wht`

**หัก ณ ที่จ่าย (WHT)**

> Source: `app/[locale]/(admin)/admin/wht/page.tsx` · Group: `(admin)`
...
- ตรวจข้อมูลที่ดึงจาก DB แสดงครบ (ไม่ใช่ ฿0/ว่างทั้งที่ควรมีข้อมูล) — table: `admins`, `withholding_tax_entries`
