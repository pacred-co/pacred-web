# Test Cases — `/admin/cargothai`

**หน้า CargoThai (warehouse-ops/ติดตาม)**

> Source: `app/[locale]/(admin)/admin/cargothai/page.tsx` · Group: `(admin)`
...
- ตรวจข้อมูลที่ดึงจาก DB แสดงครบ (ไม่ใช่ ฿0/ว่างทั้งที่ควรมีข้อมูล) — table: `admins`, `tb_tmp_forwarder_cargothai`, `tb_tmp_forwarder_item_cargothai`

**ผลทดสอบ:**  `[ ] ✅ ผ่าน`   `[ ] ❌ ไม่ผ่าน`   `[ ] 🔧 ต้องแก้/ไม่ถูกต้อง`   `[ ] ⏭ ข้าม`

**หมายเหตุ / บั๊กที่เจอ:** _______________________________________________

### TC-05 · Feature — `adminSyncCargoThai()`

**Action:** `actions/admin/cargothai` → `adminSyncCargoThai`
