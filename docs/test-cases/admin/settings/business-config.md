# Test Cases — `/admin/settings/business-config`

**ตั้งค่าธุรกิจ (key-value)**

> Source: `app/[locale]/(admin)/admin/settings/business-config/page.tsx` · Group: `(admin)`
...
### TC-05 · Feature — `adminUpdateBusinessConfig()`

**Action:** `actions/admin/business-config` → `adminUpdateBusinessConfig`
