# Test Cases — `/admin/settings/promos`

**จัดการโปรโมชัน + อัปโหลดรูปแบนเนอร์**

> Source: `app/[locale]/(admin)/admin/settings/promos/page.tsx` · Group: `(admin)`
...
- ตรวจข้อมูลที่ดึงจาก DB แสดงครบ (ไม่ใช่ ฿0/ว่างทั้งที่ควรมีข้อมูล) — table: `admins`, `business_config`

**ผลทดสอบ:**  `[ ] ✅ ผ่าน`   `[ ] ❌ ไม่ผ่าน`   `[ ] 🔧 ต้องแก้/ไม่ถูกต้อง`   `[ ] ⏭ ข้าม`

**หมายเหตุ / บั๊กที่เจอ:** _______________________________________________

### TC-05 · Feature — `adminSavePromoBanners()`

**Action:** `actions/admin/promo-banners` → `adminSavePromoBanners`
...
### TC-06 · Feature — `adminSeedLegacyImportPromo()`

**Action:** `actions/admin/promo-banners` → `adminSeedLegacyImportPromo`
