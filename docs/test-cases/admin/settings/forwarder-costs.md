# Test Cases — `/admin/settings/forwarder-costs`

**ตั้งค่าต้นทุนนำเข้า (matrix)**

> Source: `app/[locale]/(admin)/admin/settings/forwarder-costs/page.tsx` · Group: `(admin)`
...
### TC-06 · Feature — `adminSetTbSettingsForwarderCosts()`

**Action:** `actions/admin/tb-settings` → `adminSetTbSettingsForwarderCosts`
