# Test Cases — `/admin/notifications/dispatch`

**ส่งการแจ้งเตือน**

> Source: `app/[locale]/(admin)/admin/notifications/dispatch/page.tsx` · Group: `(admin)`
...
- ตรวจข้อมูลที่ดึงจาก DB แสดงครบ (ไม่ใช่ ฿0/ว่างทั้งที่ควรมีข้อมูล) — table: `admins`, `notifications`

**ผลทดสอบ:**  `[ ] ✅ ผ่าน`   `[ ] ❌ ไม่ผ่าน`   `[ ] 🔧 ต้องแก้/ไม่ถูกต้อง`   `[ ] ⏭ ข้าม`

**หมายเหตุ / บั๊กที่เจอ:** _______________________________________________

### TC-05 · Feature — `retryNotificationDispatch()`

**Action:** `actions/admin/notifications` → `retryNotificationDispatch`
