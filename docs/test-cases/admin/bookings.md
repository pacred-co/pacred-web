# Test Cases — `/admin/bookings`

**การจอง (admin)**

> Source: `app/[locale]/(admin)/admin/bookings/page.tsx` · Group: `(admin)`
...
- ตรวจข้อมูลที่ดึงจาก DB แสดงครบ (ไม่ใช่ ฿0/ว่างทั้งที่ควรมีข้อมูล) — table: `admins`, `bookings`
