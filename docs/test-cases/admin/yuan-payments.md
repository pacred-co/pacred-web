# Test Cases — `/admin/yuan-payments`

**รายการฝากโอนหยวน (admin)**

> Source: `app/[locale]/(admin)/admin/yuan-payments/page.tsx` · Group: `(admin)`
...
- ตรวจข้อมูลที่ดึงจาก DB แสดงครบ (ไม่ใช่ ฿0/ว่างทั้งที่ควรมีข้อมูล) — table: `admins`, `tb_admin`, `tb_forwarder`, `tb_payment`, `tb_users`, `tb_wallet`, `tb_wallet_hs`

**ผลทดสอบ:**  `[ ] ✅ ผ่าน`   `[ ] ❌ ไม่ผ่าน`   `[ ] 🔧 ต้องแก้/ไม่ถูกต้อง`   `[ ] ⏭ ข้าม`

**หมายเหตุ / บั๊กที่เจอ:** _______________________________________________

### TC-05 · Feature — `adminBulkApproveYuanPaymentsTb()`

**Action:** `actions/admin/tb-bulk` → `adminBulkApproveYuanPaymentsTb`
