# Test Cases — `/admin/drivers`

**รายชื่อคนขับ**

> Source: `app/[locale]/(admin)/admin/drivers/page.tsx` · Group: `(admin)`
...
- ตรวจข้อมูลที่ดึงจาก DB แสดงครบ (ไม่ใช่ ฿0/ว่างทั้งที่ควรมีข้อมูล) — table: `admins`, `tb_forwarder`, `tb_forwarder_driver`, `tb_forwarder_driver_item`, `tb_users`
