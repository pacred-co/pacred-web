# Test Cases — `/admin/wallet/add`

**เติมเงินให้ลูกค้า (admin manual)**

> Source: `app/[locale]/(admin)/admin/wallet/add/page.tsx` · Group: `(admin)`
...
### TC-05 · Feature — `adminCreateWalletHsManual()`

**Action:** `actions/admin/wallet-hs` → `adminCreateWalletHsManual`
