# Test Cases — `/admin/wallet/withdrawals`

**คำขอถอนเงิน (admin)**

> Source: `app/[locale]/(admin)/admin/wallet/withdrawals/page.tsx` · Group: `(admin)`
...
### TC-05 · Feature — `adminApproveWithdraw()`
...
### TC-06 · Feature — `adminRejectWithdraw()`
