# Test Cases — `/admin/carriers`

**ผู้ให้บริการขนส่ง (carriers)**

> Source: `app/[locale]/(admin)/admin/carriers/page.tsx` · Group: `(admin)`
...
- ตรวจข้อมูลที่ดึงจาก DB แสดงครบ (ไม่ใช่ ฿0/ว่างทั้งที่ควรมีข้อมูล) — table: `carriers`

**ผลทดสอบ:**  `[ ] ✅ ผ่าน`   `[ ] ❌ ไม่ผ่าน`   `[ ] 🔧 ต้องแก้/ไม่ถูกต้อง`   `[ ] ⏭ ข้าม`

**หมายเหตุ / บั๊กที่เจอ:** _______________________________________________

### TC-04 · Feature — `adminUpsertCarrier()`

**Action:** `actions/admin/carriers` → `adminUpsertCarrier`
...
### TC-05 · Feature — `adminDeactivateCarrier()`

**Action:** `actions/admin/carriers` → `adminDeactivateCarrier`
