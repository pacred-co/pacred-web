# Test Cases — `/admin/rates/custom-hs`

**เรทเฉพาะตาม HS code**

> Source: `app/[locale]/(admin)/admin/rates/custom-hs/page.tsx` · Group: `(admin)`
...
### TC-05 · Feature — `adminUpdateCustomerHsRates()`

**Action:** `actions/admin/rate-edits` → `adminUpdateCustomerHsRates`
