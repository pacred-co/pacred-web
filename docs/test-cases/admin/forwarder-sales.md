# Test Cases — `/admin/forwarder-sales`

**คอมมิชชันการขายจากออเดอร์นำเข้า**

> Source: `app/[locale]/(admin)/admin/forwarder-sales/page.tsx` · Group: `(admin)`
...
- แสดง component หลัก: `csv-button`, `date-filter`, `page-top-menubar`
- ตรวจข้อมูลที่ดึงจาก DB แสดงครบ (ไม่ใช่ ฿0/ว่างทั้งที่ควรมีข้อมูล) — table: `admins`, `tb_admin`, `tb_forwarder`, `tb_sales_report`, `tb_users`
