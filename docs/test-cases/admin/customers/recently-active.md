# Test Cases — `/admin/customers/recently-active`

**ลูกค้าที่ active ล่าสุด**

> Source: `app/[locale]/(admin)/admin/customers/recently-active/page.tsx` · Group: `(admin)`
...
- ตรวจข้อมูลที่ดึงจาก DB แสดงครบ (ไม่ใช่ ฿0/ว่างทั้งที่ควรมีข้อมูล) — table: `admins`, `tb_users`
