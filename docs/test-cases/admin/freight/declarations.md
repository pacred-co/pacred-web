# Test Cases — `/admin/freight/declarations`

**ใบขนสินค้า (customs declarations)**

> Source: `app/[locale]/(admin)/admin/freight/declarations/page.tsx` · Group: `(admin)`
...
- ตรวจข้อมูลที่ดึงจาก DB แสดงครบ (ไม่ใช่ ฿0/ว่างทั้งที่ควรมีข้อมูล) — table: `admins`, `customs_declarations`, `freight_shipments`
