# Test Cases — `/admin/freight/declarations/[id]`

**รายละเอียดใบขนสินค้า**

> Source: `app/[locale]/(admin)/admin/freight/declarations/[id]/page.tsx` · Group: `(admin)`
...
- ตรวจข้อมูลที่ดึงจาก DB แสดงครบ (ไม่ใช่ ฿0/ว่างทั้งที่ควรมีข้อมูล) — table: `admin_audit_log`, `admins`, `customs_declaration_lines`, `customs_declarations`, `freight_invoice_lines`, `freight_invoices`, `freight_shipments`, `hs_codes`, `profiles`
...
### TC-06 · Feature — `adminUpdateDeclarationHeader()`

**Action:** `actions/admin/customs-declarations` → `adminUpdateDeclarationHeader`
...
### TC-07 · Feature — `adminAddDeclarationLine()`

**Action:** `actions/admin/customs-declarations` → `adminAddDeclarationLine`
...
### TC-08 · Feature — `adminUpdateDeclarationLine()`

**Action:** `actions/admin/customs-declarations` → `adminUpdateDeclarationLine`
...
### TC-09 · Feature — `adminDeleteDeclarationLine()`

**Action:** `actions/admin/customs-declarations` → `adminDeleteDeclarationLine`
...
### TC-10 · Feature — `adminSubmitDeclaration()`

**Action:** `actions/admin/customs-declarations` → `adminSubmitDeclaration`
...
### TC-11 · Feature — `adminMarkAccepted()`

**Action:** `actions/admin/customs-declarations` → `adminMarkAccepted`
...
### TC-12 · Feature — `adminMarkReleased()`

**Action:** `actions/admin/customs-declarations` → `adminMarkReleased`
...
### TC-13 · Feature — `adminCancelDeclaration()`

**Action:** `actions/admin/customs-declarations` → `adminCancelDeclaration`
...
### TC-15 · สถานะ pending ระหว่างทำรายการ
