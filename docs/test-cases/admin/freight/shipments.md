# Test Cases — `/admin/freight/shipments`

**shipment freight (admin)**

> Source: `app/[locale]/(admin)/admin/freight/shipments/page.tsx` · Group: `(admin)`
...
- ตรวจข้อมูลที่ดึงจาก DB แสดงครบ (ไม่ใช่ ฿0/ว่างทั้งที่ควรมีข้อมูล) — table: `admins`, `freight_shipments`
