# Test Cases — `/admin/containers/[id]/hs`

**HS lines ของตู้**

> Source: `app/[locale]/(admin)/admin/containers/[id]/hs/page.tsx` · Group: `(admin)`
...
- ตรวจข้อมูลที่ดึงจาก DB แสดงครบ (ไม่ใช่ ฿0/ว่างทั้งที่ควรมีข้อมูล) — table: `container_hs_lines`, `containers`, `hs_codes`
...
### TC-05 · Feature — `addHsLine()`

**Action:** `actions/admin/hs-codes` → `addHsLine`
...
### TC-06 · Feature — `deleteHsLine()`

**Action:** `actions/admin/hs-codes` → `deleteHsLine`
