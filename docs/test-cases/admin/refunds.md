# Test Cases — `/admin/refunds`

**คำขอคืนเงิน (admin)**

> Source: `app/[locale]/(admin)/admin/refunds/page.tsx` · Group: `(admin)`
...
- ตรวจข้อมูลที่ดึงจาก DB แสดงครบ (ไม่ใช่ ฿0/ว่างทั้งที่ควรมีข้อมูล) — table: `admins`, `refund_requests`
