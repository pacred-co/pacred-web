# Test Cases — `/admin/system/notifications`

**การแจ้งเตือนระบบ**

> Source: `app/[locale]/(admin)/admin/system/notifications/page.tsx` · Group: `(admin)`
...
- ตรวจข้อมูลที่ดึงจาก DB แสดงครบ (ไม่ใช่ ฿0/ว่างทั้งที่ควรมีข้อมูล) — table: `admins`, `notifications`, `profiles`
