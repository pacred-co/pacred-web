# Test Cases — `/admin/api-forwarder-momo`

**เชื่อม API MOMO forwarder**

> Source: `app/[locale]/(admin)/admin/api-forwarder-momo/page.tsx` · Group: `(admin)`
...
- ตรวจข้อมูลที่ดึงจาก DB แสดงครบ (ไม่ใช่ ฿0/ว่างทั้งที่ควรมีข้อมูล) — table: `admins`, `momo_import_tracks`, `momo_sync_logs`, `tb_forwarder`
