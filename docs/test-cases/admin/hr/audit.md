# Test Cases — `/admin/hr/audit`

**audit ฝั่ง HR**

> Source: `app/[locale]/(admin)/admin/hr/audit/page.tsx` · Group: `(admin)`
...
- ตรวจข้อมูลที่ดึงจาก DB แสดงครบ (ไม่ใช่ ฿0/ว่างทั้งที่ควรมีข้อมูล) — table: `admins`, `employee_audit_entries`

**ผลทดสอบ:**  `[ ] ✅ ผ่าน`   `[ ] ❌ ไม่ผ่าน`   `[ ] 🔧 ต้องแก้/ไม่ถูกต้อง`   `[ ] ⏭ ข้าม`

**หมายเหตุ / บั๊กที่เจอ:** _______________________________________________

### TC-04 · Feature — `adminCreateAuditEntry()`

**Action:** `actions/admin/employee-audit` → `adminCreateAuditEntry`
...
### TC-05 · Feature — `adminDeleteAuditEntry()`

**Action:** `actions/admin/employee-audit` → `adminDeleteAuditEntry`
