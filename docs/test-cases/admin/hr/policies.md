# Test Cases — `/admin/hr/policies`

**นโยบายบริษัท**

> Source: `app/[locale]/(admin)/admin/hr/policies/page.tsx` · Group: `(admin)`
...
- ตรวจข้อมูลที่ดึงจาก DB แสดงครบ (ไม่ใช่ ฿0/ว่างทั้งที่ควรมีข้อมูล) — table: `admins`, `policies`, `policy_acknowledgments`

**ผลทดสอบ:**  `[ ] ✅ ผ่าน`   `[ ] ❌ ไม่ผ่าน`   `[ ] 🔧 ต้องแก้/ไม่ถูกต้อง`   `[ ] ⏭ ข้าม`

**หมายเหตุ / บั๊กที่เจอ:** _______________________________________________

### TC-04 · Feature — `adminUpsertPolicy()`

**Action:** `actions/admin/policies` → `adminUpsertPolicy`
...
### TC-05 · Feature — `adminTogglePublishPolicy()`

**Action:** `actions/admin/policies` → `adminTogglePublishPolicy`
...
### TC-06 · Feature — `adminDeletePolicy()`

**Action:** `actions/admin/policies` → `adminDeletePolicy`
