# Test Cases — `/admin/hr/training`

**อบรมพนักงาน**

> Source: `app/[locale]/(admin)/admin/hr/training/page.tsx` · Group: `(admin)`
...
- ตรวจข้อมูลที่ดึงจาก DB แสดงครบ (ไม่ใช่ ฿0/ว่างทั้งที่ควรมีข้อมูล) — table: `admins`, `training_courses`, `training_enrollments`

**ผลทดสอบ:**  `[ ] ✅ ผ่าน`   `[ ] ❌ ไม่ผ่าน`   `[ ] 🔧 ต้องแก้/ไม่ถูกต้อง`   `[ ] ⏭ ข้าม`

**หมายเหตุ / บั๊กที่เจอ:** _______________________________________________

### TC-04 · Feature — `adminUpsertCourse()`

**Action:** `actions/admin/learning` → `adminUpsertCourse`
...
### TC-05 · Feature — `adminDeleteCourse()`

**Action:** `actions/admin/learning` → `adminDeleteCourse`
...
### TC-06 · Feature — `adminEnroll()`

**Action:** `actions/admin/learning` → `adminEnroll`
...
### TC-07 · Feature — `adminBulkEnrollActiveAdmins()`

**Action:** `actions/admin/learning` → `adminBulkEnrollActiveAdmins`
...
### TC-08 · Feature — `adminSetEnrollmentStatus()`

**Action:** `actions/admin/learning` → `adminSetEnrollmentStatus`
