# Test Cases — `/admin/audit`

**บันทึกการกระทำของผู้ดูแล (audit log)**

> Source: `app/[locale]/(admin)/admin/audit/page.tsx` · Group: `(admin)`
...
- ตรวจข้อมูลที่ดึงจาก DB แสดงครบ (ไม่ใช่ ฿0/ว่างทั้งที่ควรมีข้อมูล) — table: `admin_audit_log`, `admins`, `profiles`
