# Test Cases — `/admin/api-forwarder-cn/manual`

**กรอกข้อมูล CN forwarder เอง**

> Source: `app/[locale]/(admin)/admin/api-forwarder-cn/manual/page.tsx` · Group: `(admin)`
...
- แสดง component หลัก: `page-top-menubar`, `api-forwarder-manual-form`
