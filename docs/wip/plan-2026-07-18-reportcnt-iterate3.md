...
- [x] **K. สี VIVID จี๊ดจ๊าด (ไม่จืด) — selection + tag/status ทั้งระบบ:**
...
- [x] **L. หัวแถว/หัวบิล (summary) = รายละเอียดครบเหมือนแถวเดี่ยว:**
...
- [x] **M. Backfill คิวรอตรวจสอบ (tb_check_forwarder) + ตู้ถึงไทยแล้ว (fstatus≥4) — fill ค่าครบ:**
