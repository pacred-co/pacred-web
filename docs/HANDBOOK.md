...
- **Phase A — Data migration ✅ DONE** — all 117 tables loaded on dev + prod Supabase (migrations `0081`-`0083` + `0087`; ~8,898 customers); Supabase Pro upgrade done (ก๊อต) → 3 oversized log tables (`tb_web_hs`/`tb_history_key`/`tb_history`) backfilled post-Pro; customer image + storage files uploaded to Supabase S3 production by ภูม 2026-05-24 (`pcsracgo/public/member`). Runbook: [`runbook/pcs-data-migration.md`](runbook/pcs-data-migration.md).
...
- **Phase A — data migration ✅ DONE:** all 117 tables loaded on dev + prod Supabase — `0081`-`0083` + `0087` applied, ~8,898 customers with intact login hashes. Supabase Pro upgrade done (ก๊อต) → 3 oversized log tables backfilled post-Pro; customer image + storage files uploaded to Supabase S3 production by ภูม 2026-05-24. See [`runbook/pcs-data-migration.md`](runbook/pcs-data-migration.md).
