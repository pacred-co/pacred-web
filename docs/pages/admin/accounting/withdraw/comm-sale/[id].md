# `/admin/accounting/withdraw/comm-sale/[id]`

**รายละเอียดเบิกคอมเซล**

> **Auth:** 🛡 Admin — roles: `accounting`, `sales_admin`
> **Group:** `(admin)` · **Source:** `app/[locale]/(admin)/admin/accounting/withdraw/comm-sale/[id]/page.tsx`
...
- `AdminWithdrawCommSaleDetailPage`
