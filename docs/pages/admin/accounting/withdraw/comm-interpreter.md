# `/admin/accounting/withdraw/comm-interpreter`

**เบิกคอมล่าม**

> **Auth:** 🛡 Admin — roles: `accounting`, `sales_admin`
> **Group:** `(admin)` · **Source:** `app/[locale]/(admin)/admin/accounting/withdraw/comm-interpreter/page.tsx`
...
- `AdminWithdrawCommInterpreterPage`
