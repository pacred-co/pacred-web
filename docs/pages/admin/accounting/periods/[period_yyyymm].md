# `/admin/accounting/periods/[period_yyyymm]`

**รายละเอียดงวดบัญชี**

> **Auth:** 🛡 Admin — roles: `super`, `accounting`, `ops`
> **Group:** `(admin)` · **Source:** `app/[locale]/(admin)/admin/accounting/periods/[period_yyyymm]/page.tsx`

## Request data (params)

- **route param** `period_yyyymm`
...
- `AdminAccountingPeriodDetailPage`
