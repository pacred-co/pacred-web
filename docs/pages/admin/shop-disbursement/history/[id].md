# `/admin/shop-disbursement/history/[id]`

**รายละเอียดเบิกจ่ายร้านค้า**

> **Auth:** 🛡 Admin — roles: `accounting`, `super`
> **Group:** `(admin)` · **Source:** `app/[locale]/(admin)/admin/shop-disbursement/history/[id]/page.tsx`
...
- `lib/admin/bank-names`
- `lib/auth/require-admin`

## Exports / functions

- `AdminShopDisbursementBatchPage`
