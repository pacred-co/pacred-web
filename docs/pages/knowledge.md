...
**คลังความรู้ (knowledge base) — รายการบทความ**

> **Auth:** 🌐 Public (no auth)
> **Group:** `(public)` · **Source:** `app/[locale]/(public)/knowledge/page.tsx`
...
- `components/sections/article-list-tabs`
