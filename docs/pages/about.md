...
**เกี่ยวกับบริษัท Pacred — ประวัติ วิสัยทัศน์ ทีมงาน**

> **Auth:** 🌐 Public (no auth)
> **Group:** `(public)` · **Source:** `app/[locale]/(public)/about/page.tsx`
...
- `components/sections/pacred-experience`
- `components/sections/search-bar`
- `components/sections/why-pacred`
