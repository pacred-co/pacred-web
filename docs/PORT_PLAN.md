...
- เดฟ: D-7a/b/c/d = 4 items blocked on creds/owner decisions; D-11/D-12/D-13 ✅ all scaffolded (need DSN / Upstash creds / hCaptcha keys to activate); D-12-wire + D-13-wire = 1-2h each follow-up wiring tasks
