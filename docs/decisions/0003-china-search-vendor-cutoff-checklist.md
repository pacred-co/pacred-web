...
> **Companion to:** [`docs/decisions/0003-china-search-vendor.md`](./0003-china-search-vendor.md)
> **Why this file exists:** ภูม + เดฟ + ก๊อต agreed (2026-05-15) to ship with TAM API in production interim, then ก๊อต swaps it out. This file makes the swap-out **actionable** — not just a vague "we'll do it later".
> **Status:** Pending — waiting on Phase H+ (post-launch) start signal from ก๊อต.
> **Owner:** ก๊อต (per K-ADR-vendor-cutoff in `docs/PORT_PLAN.md` §O5)
