!(function (e, n, a) {
    ...
    if (
        (a(e).on("load", function () {
            ...
            !1 === a.app.nav.initialized && a.app.nav.init({ speed: 300 }),
                ...
                /*a(".navbar-hide-on-scroll").length > 0 &&
                    (a(".navbar-hide-on-scroll.fixed-top").headroom({ offset: 205, tolerance: 5, classes: { initial: "headroom", pinned: "headroom--pinned-top", unpinned: "headroom--unpinned-top" } }),
                    a(".navbar-hide-on-scroll.fixed-bottom").headroom({ offset: 205, tolerance: 5, classes: { initial: "headroom", pinned: "headroom--pinned-bottom", unpinned: "headroom--unpinned-bottom" } })),
                setTimeout(function () {
                    var e;
                ...
                a(".scrollable-container").length > 0 &&
            ...
            "vertical-compact-menu" != o && "horizontal-menu" != o && !1 === i && a(".main-menu-content").find("li.active").parents("li").addClass("open"),
                ("vertical-compact-menu" != o && "horizontal-menu" != o) ||
                    (a(".main-menu-content").find("li.active").parents("li:not(.nav-item)").addClass("open"), a(".main-menu-content").find("li.active").parents("li").addClass("active")),
            ...
            a(".nav-link-search").on("click", function () {
                ...
                a(".search-input .input").on("keyup", function (e) {
                    if (38 !== e.keyCode && 40 !== e.keyCode && 13 !== e.keyCode) {
                        27 == e.keyCode &&
                            ...
                            a(".search-list").hasClass("show") && (a(this).removeClass("show"), a(".search-input").removeClass("show")));
                        ...
                        if ((a("ul.search-list li").remove(), "" != n)) {
                            ...
                            var t = "",
                                ...
                                i = "",
                                o = 0;
                            a.getJSON("../assets/data/" + c + ".json", function (e) {
                                for (var l = 0; l < e.listItems.length; l++)
                                    ((0 == e.listItems[l].name.toLowerCase().indexOf(n) && o < 10) || (0 != e.listItems[l].name.toLowerCase().indexOf(n) && e.listItems[l].name.toLowerCase().indexOf(n) > -1 && o < 10)) &&
                                        ((t +=
                ...
                a(e).on("keydown", function (n) {
                    ...
                    if (
                        (40 === n.keyCode ? ((t = i.next()), i.removeClass("current_item"), (i = t.addClass("current_item"))) : 38 === n.keyCode && ((s = i.prev()), i.removeClass("current_item"), (i = s.addClass("current_item"))),
        ...
        var o = n.querySelector(".drag-target"),
            l = "panright",
            r = "panleft";
        if ((!0 === i && ((l = "panleft"), (r = "panright")), a(o).length > 0))
        ...
        setTimeout(function () {
            ...
            a(t).length > 0 &&
                ((e = new Hammer(t)).get("pan").set({ direction: Hammer.DIRECTION_ALL, threshold: 100 }),
                e.on(r, function (e) {
    ...
    a(n).on("click", ".menu-toggle, .modern-nav-toggle", function (n) {
        ...
        $( document ).ready(function() {
            if (!Cookies.get('set_pcsLangCook')) {
                var s = 'th';
                $('#dropdown-flag').html('<i class="flag-icon flag-icon-th"></i><span class="selected-language">ภาษาไทย</span> <i class="ft-chevron-down"></i>');
            }else{
                var s = Cookies.get('set_pcsLangCook');
                if(s=='en'){
                    var nameLang = 'English';
                    var sFlag = 'us';
                }else if(s=='ch'){
                    var nameLang = 'Chinese';
                    var sFlag = 'ch';
                }else{
                    var nameLang = 'ภาษาไทย';
                    var sFlag = 'th';
                }
                $('#dropdown-flag').html('<i class="flag-icon flag-icon-'+sFlag+'"></i><span class="selected-language">'+nameLang+'</span> <i class="ft-chevron-down"></i>');
            }
        }),
        ...
        a(".dropdown-language .dropdown-item").on("click", function () {
            ...
            Cookies.set('set_pcsLangCook', pcsLangCook, { expires: date });
            console.log(s);         
        });
...
function pcsLangMenu(s){
    if(s=='en'){
        $.getScript(basePath+"assets/js/lang/en.js", function() {});
        var s2 = 'zh-CN|en';
    }else if(s=='ch'){
        $.getScript(basePath+"assets/js/lang/ch.js", function() {});
        var s2 = 'zh-CN|zh-CN';
    }else{
        $.getScript(basePath+"assets/js/lang/th.js", function() {});
        var s2 = 'zh-CN|th';
    }
    doGTranslate(s2);
    //var url = window.location.pathname.replace(/&?e=([^&]$|[^&]*)/i, "");
    //console.log(url);
    //if('/pcscargo/member/'==url){
    //    searchHomeRecom(s);
    //    searchHomeRecomTaobao(s);
    //}
    //if('/pcscargo/member/search/'==url){
    //    searchURL(s);
    //    searchKey(s);
    //}
