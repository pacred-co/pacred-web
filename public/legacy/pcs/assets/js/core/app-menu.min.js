!(function (e, n, a) {
    ...
    (a.app.menu = {
        ...
        manualScroller: {
            obj: null,
            init: function () {
                a.app.menu.is_touch_device() ? a(".main-menu").addClass("menu-native-scroll") : (this.obj = new PerfectScrollbar(".main-menu-content", { suppressScrollX: !0, wheelPropagation: !1 }));
            },
            update: function () {
                if (this.obj) {
            ...
            updateHeight: function () {
                ("vertical-menu" != t.data("menu") && "vertical-menu-modern" != t.data("menu") && "vertical-overlay-menu" != t.data("menu")) ||
                    !a(".main-menu").hasClass("menu-fixed") ||
                    (a(".main-menu-content").css("height", a(e).height() - a(".header-navbar").height() - a(".main-menu-header").outerHeight()), this.update());
            },
        },
        init: function (e) {
        ...
        change: function (n) {
            ...
            ("vertical-menu" !== s && "vertical-compact-menu" !== s && "vertical-content-menu" !== s && "vertical-menu-modern" !== s) || this.toOverlayMenu(i.name, s),
                t.is(".horizontal-layout") && !t.hasClass(".horizontal-menu-demo") && (this.changeMenu(i.name), a(".menu-toggle").removeClass("is-active")),
                "xl" == i.name &&
                ...
                "horizontal-menu" == s &&
                    (a("li.dropdown-submenu .dropdown-item").on("click", function () {
                        ...
                        if (n.length) {
                            ...
                            "ltr" === a("html").data("textdirection") && s + o - (e.innerWidth - 16) >= 0
                                ? a(this).parent().find(".dropdown-menu").addClass("open-left")
                                : "rtl" === a("html").data("textdirection") && s + o - (e.innerWidth - 1e3) <= 0 && a(this).parent().find(".dropdown-menu").addClass("open-left");
                        }
                    }),
            ...
            t.addClass("changing-menu"),
                ...
                t.hasClass("vertical-layout") &&
                    (t.hasClass("menu-open") || t.hasClass("menu-expanded")
                        ? (a(".menu-toggle").addClass("is-active"), ("vertical-menu" !== t.data("menu") && "vertical-content-menu" !== t.data("menu")) || (a(".main-menu-header") && a(".main-menu-header").show()))
                        : (a(".menu-toggle").removeClass("is-active"), ("vertical-menu" !== t.data("menu") && "vertical-content-menu" !== t.data("menu")) || (a(".main-menu-header") && a(".main-menu-header").hide()))),
                setTimeout(function () {
            ...
            this.transit(
                function () {
                    t.removeClass("menu-hide menu-collapsed").addClass("menu-open"),
                        (this.hidden = !1),
                        (this.expanded = !0),
                        t.hasClass("vertical-overlay-menu") && (a(".sidenav-overlay").removeClass("d-none").addClass("d-block"), t.css("overflow", "hidden"));
                },
                function () {
                    !a(".main-menu").hasClass("menu-native-scroll") &&
                        a(".main-menu").hasClass("menu-fixed") &&
                        (this.manualScroller.enable(), a(".main-menu-content").css("height", a(e).height() - a(".header-navbar").height() - a(".main-menu-header").outerHeight())),
                        "vertical-compact-menu" != t.data("menu") || t.hasClass("vertical-overlay-menu") || (a(".sidenav-overlay").removeClass("d-block d-none"), a("body").css("overflow", "auto"));
                }
            );
        },
        hide: function () {
            this.transit(
                function () {
                    t.removeClass("menu-open menu-expanded").addClass("menu-hide"),
                        (this.hidden = !0),
                        (this.expanded = !1),
                        t.hasClass("vertical-overlay-menu") && (a(".sidenav-overlay").removeClass("d-block").addClass("d-none"), a("body").css("overflow", "auto"));
                },
                function () {
        ...
        expand: function () {
            !1 === this.expanded &&
                ("vertical-menu-modern" == t.data("menu") && a(".modern-nav-toggle").find(".toggle-icon").removeClass("ft-toggle-left").addClass("ft-toggle-right"),
                this.transit(
                    function () {
                    ...
                    function () {
                        a(".main-menu").hasClass("menu-native-scroll") || "horizontal-menu" == t.data("menu") ? this.manualScroller.disable() : a(".main-menu").hasClass("menu-fixed") && this.manualScroller.enable(),
                            ("vertical-menu" != t.data("menu") && "vertical-menu-modern" != t.data("menu")) ||
                                !a(".main-menu").hasClass("menu-fixed") ||
        ...
        collapse: function (n) {
            !1 === this.collapsed &&
                ("vertical-menu-modern" == t.data("menu") && a(".modern-nav-toggle").find(".toggle-icon").removeClass("ft-toggle-right").addClass("ft-toggle-left"),
                this.transit(
                    function () {
                    ...
                    function () {
                        "vertical-content-menu" == t.data("menu") && this.manualScroller.disable(),
                            ...
                            ("vertical-menu" != t.data("menu") && "vertical-menu-modern" != t.data("menu")) ||
                                !a(".main-menu").hasClass("menu-fixed") ||
                                (a(".main-menu-content").css("height", a(e).height() - a(".header-navbar").height()), a(".main-menu-content").hasClass("ps") || this.manualScroller.enable());
                    }
                ));
        },
        toOverlayMenu: function (e, n) {
            ...
            "vertical-menu-modern" == n
                ? "md" == e || "sm" == e || "xs" == e
                    ...
                    : t.hasClass("vertical-overlay-menu") && t.removeClass("vertical-overlay-menu").addClass(i)
                : "sm" == e || "xs" == e
                ? (t.hasClass(i) && t.removeClass(i).addClass("vertical-overlay-menu"), "vertical-content-menu" == i && a(".main-menu").addClass("menu-fixed"))
                : (t.hasClass("vertical-overlay-menu") && t.removeClass("vertical-overlay-menu").addClass(i), "vertical-content-menu" == i && a(".main-menu").removeClass("menu-fixed"));
        },
        changeMenu: function (e) {
            ...
            "xl" === e
                ? (t.removeClass("vertical-layout vertical-overlay-menu fixed-navbar").addClass(t.data("menu")),
        ...
        toggle: function () {
            ...
            switch (e.name) {
                ...
                case "lg":
                    !0 === n
                        ? "vertical-compact-menu" == i || "vertical-overlay-menu" == i || "horizontal-menu" == i
                            ? this.hide()
                            : this.collapse()
                        : "vertical-compact-menu" == i || "vertical-overlay-menu" == i || "horizontal-menu" == i
                        ? this.open()
                ...
                case "md":
                    !0 === n
                        ? "vertical-compact-menu" == i || "vertical-overlay-menu" == i || "vertical-menu-modern" == i || "horizontal-menu" == i
                            ? this.hide()
                            : this.collapse()
                        : "vertical-compact-menu" == i || "vertical-overlay-menu" == i || "vertical-menu-modern" == i || "horizontal-menu" == i
                        ? this.open()
                ...
                a(".navigation-main")
                    .on("mouseenter.app.menu", "li", function () {
                        ...
                        if (
                            ...
                            if (
                                (n.hasClass("has-sub") || ((i = n.find("span.menu-title").text()), (s = n.children("a").attr("href")), "" !== i && ((l = a("<a>")).attr("href", s), l.attr("title", i), l.text(i), l.addClass("menu-title"))),
                                ...
                                "vertical-compact-menu" !== t.data("menu") && l.appendTo(".main-menu-content").css({ position: "fixed", top: o }),
                    ...
                    .on("click.app.menu", "li", function (e) {
                        ...
                        n.is(".disabled")
                            ? e.preventDefault()
                            : (t.hasClass("menu-collapsed") && "vertical-menu-modern" != t.data("menu")) || ("vertical-compact-menu" == t.data("menu") && n.is(".has-sub") && !t.hasClass("vertical-overlay-menu"))
                            ? e.preventDefault()
                            : n.has("ul")
                            ? n.is(".open")
                            ...
                            t.hasClass("menu-collapsed") &&
                                ...
                                setTimeout(function () {
                                    if (
                                        ...
                                        a(".user-profile .user-info .dropdown").hasClass("show") && (a(".user-profile .user-info .dropdown").removeClass("show"), a(".user-profile .user-info .dropdown .dropdown-menu").removeClass("show")),
                                        t.hasClass("menu-collapsed"))
                                    ) {
                    ...
                    a(".main-menu-content").on("mouseleave", function () {
                        (t.hasClass("menu-collapsed") || "vertical-compact-menu" == t.data("menu")) &&
                            (a(".main-menu-content").children("span.menu-title").remove(), a(".main-menu-content").children("a.menu-title").remove(), a(".main-menu-content").children("ul.menu-content").remove()),
                            a(".hover", ".navigation-main").removeClass("hover");
                    }),
            ...
            adjustSubmenu: function (e) {
                ...
                if (
                    ...
                    "vertical-compact-menu" === t.data("menu")
                        ...
                        ? ((s = n + e.height() + r - 5), (l = o - a(".content-header").height() - e.height() - n - 60), t.hasClass("material-vertical-layout") && (s = n + e.height() + a(".user-profile").height() + r))
                        : (s = t.hasClass("material-vertical-layout") ? n + e.height() + a(".user-profile").height() + r : n + e.height() + r),
                    !1 !== this.detectIE() && t.hasClass("material-vertical-layout") && (s = n + e.height() + a(".user-profile").height() + r + a(".header-navbar").height()),
                    "vertical-content-menu" == t.data("menu"))
                )
                    m.addClass("menu-popout").appendTo(".main-menu-content").css({ top: s, position: "fixed" });
                else {
                    m.addClass("menu-popout").appendTo(".main-menu-content").css({ top: s, position: "fixed", "max-height": l });
                    new PerfectScrollbar(".main-menu-content > ul.menu-content");
                }
            },
            fullSubmenu: function (e) {
                e.children("ul:first").clone(!0).addClass("menu-popout").appendTo(".main-menu-content").css({ top: 0, position: "fixed", height: "100%" });
                new PerfectScrollbar(".main-menu-content > ul.menu-content");
            },
