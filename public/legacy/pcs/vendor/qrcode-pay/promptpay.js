...
//
// faithful-port transcription (D1 / ADR-0017) — copied VERBATIM from
// the legacy PCS Cargo `member/assets/plugins/qrcode-pay/promptpay.js`.
// The `member/pay.php` screen loads this plugin to build the EMVCo
// PromptPay QR payload. Staged as a static `public/` asset so the
// transcribed `/pay` screen loads it via <Script> exactly as the
// legacy <script src> does. No PCS->PR rebrand applies (no branding
// text in this file).
