...
export type QuoteConditions = {
  ...
  enter: string; // Normal / Document Amend
  transit: string; // Direct / Indirect — เรือ/เที่ยวบินตรง vs ถ่ายลำที่ท่ากลาง (owner ปอน 2026-07-14)
...
export type QuoteLine = {
  ...
  /**
   * ราคาขายแยก "คอลัมน์" ของใบ (owner ปอน 2026-07-14) — key = colKey ที่ผูกกับตัวเลือกด้านบน:
   *   LCL → "4W" / "6W" (รถ 4 ล้อ / 6 ล้อ ที่ใช้ส่ง)
   *   FCL → ขนาดตู้ที่เลือกใน picker เช่น "20' GP" / "40' HC"
   * ไม่มีค่าในคอลัมน์ไหน → ใช้ unitPrice เป็น default (optional · ของเดิมไม่พัง ·
   * ยอดรวมด้านขวา [computeQuoteTotals] ยังอ่าน unitPrice เหมือนเดิม).
   */
...
export const ENTER_OPTIONS = ["Normal", "Document Amend"]; // การยื่นใบขน (owner ปอน 2026-07-14)
export const TRANSIT_OPTIONS = ["Direct", "Indirect"]; // การเดินทาง: ตรง vs ถ่ายลำ (owner ปอน 2026-07-14)
