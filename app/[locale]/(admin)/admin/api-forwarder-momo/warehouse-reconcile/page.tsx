    ...
    <main className="p-4 lg:p-8 space-y-5">
      ...
      <header>
        ...
        <p className="mt-1.5 text-sm text-muted">
          ...
          ปริมาตรรวม). คัดลอกแถวจากชีต &quot;MOMO Pacred&quot; (เลือกแถว → Ctrl/Cmd+C) แล้ววางที่นี่ ระบบจะ
          จับคู่ตามเลขแทรคกิ้ง → แสดงส่วนต่าง → ให้ตรวจก่อนบันทึก. เมื่อบันทึก จะอัปเดตเฉพาะรายการที่
          <strong>ยังไม่วางบิล</strong> แล้ว <strong>คิดราคาขายใหม่อัตโนมัติ</strong> จากค่าที่อัปเดต.
          รายการที่วางบิลแล้วจะถูกข้าม (แสดง ⚠ ให้ตรวจเอง).
        </p>
      </header>
