...
export default async function CustomersPendingPage() {
  await requireAdmin();
    ...
    <div>
      <div className="mb-6 flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-2xl font-bold text-foreground">รอ Approve</h1>
            <p className="text-sm text-muted mt-0.5">สมาชิกที่ยังไม่ครบข้อมูล รอการอนุมัติ</p>
          </div>
        </div>
