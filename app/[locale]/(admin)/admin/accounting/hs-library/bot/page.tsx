    ...
    <>
      ...
      <main className="p-6 lg:p-8 space-y-5 max-w-5xl">
        <header className="space-y-1">
          ...
          <h1 className="text-2xl font-bold">คลัง HS รวม (บอท + ไฟล์อัพเดท)</h1>
          <p className="text-xs text-muted leading-relaxed">
            คลังพิกัดรวมจาก <b>DOC BOT</b> (749) + <b>ไฟล์พิกัดอัพเดท</b> (4,586) จัดกลุ่มตามสินค้า — แต่ละสินค้ามี
