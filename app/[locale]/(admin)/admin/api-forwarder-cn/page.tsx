/**
 * /admin/api-forwarder-cn — โกดัง/พาร์ทเนอร์ที่ **เลิกใช้แล้ว** → พาไปหน้าที่ใช้จริง.
 *
 ...
 * "9" TTW/อี้อู 32 งาน · **CargoCenter = 0 งาน** (ไม่เคยมีของจริงเลย).
...
export default function RetiredApiForwarderCnPage() {
