/**
 * /admin/api-sheets-mx — manual forwarder entry through the MX warehouse.
 *
 * Wave 17 P1-6 — faithful port of legacy `pcs-admin/api-sheets-mx.php`
 * (1299 LOC). Always sets `fWarehouseName=4` (MX) on INSERT.
 */
...
export default async function ApiSheetsMxPage({
  searchParams,
}: {
  ...
  const carrier = CARRIER_REGISTRY.mx;
