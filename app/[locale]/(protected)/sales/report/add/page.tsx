...
export default async function SalesClaimPage() {
      ...
      <main className="mx-auto w-full max-w-[1200px] px-4 py-12 space-y-6">
        <div className="flex flex-wrap items-start justify-between gap-3">
          <div>
            ...
            <h1 className="mt-1 text-2xl font-bold text-foreground">{t("claimTitle")}</h1>
            <p className="mt-1 text-sm text-muted">{t("claimSubtitle")}</p>
          </div>
          <Link href="/sales/report" className="rounded-lg border border-border px-4 py-2 text-sm font-medium hover:bg-surface-alt">
            ← {t("backToReport")}
          </Link>
        </div>
