 ...
 * only. `PCS Cargo` / "บริษัท พีซีเอส คาร์โก้ จำกัด" strings the
...
export default async function ServiceImportReceiptPrintPage({
  ...
  return (
    <div className="pcs-legacy print-receipt-f">
      {/* Legacy PCS print stylesheet (printReceiptF.php inline <style>)
      ...
      <table className="table">
        ...
        <thead>
          <tr className="">
            ...
            <th colSpan={2} className="text-center">
              <h2>บริษัท พีซีเอส คาร์โก้ จำกัด</h2>
              <h3>PCS Cargo CO., LTD.</h3>
            </th>
            <th
              colSpan={3}
