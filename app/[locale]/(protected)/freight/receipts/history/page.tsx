                  ...
                  <div className="col-md-12 col-sm-12">
                    ...
                    <div className="table-responsive p-05 notranslate">
                      {/* receipt-f-hs.php L97-146 — the print form +
                          ...
                          route (method=GET, default-locale path). The
                          legacy used `printReceiptF.php?id=<csv>`; the
                          new dynamic route accepts the csv as a path
                          segment, so the form's `action` is a relative
                          base and the page JS will rewrite the URL
                          to include the csv as `/print/<csv>`. The
                          unmodified markup keeps the hidden `id` input
                          + the `#select1` click handler, so legacy
                          jQuery still works against this DOM 1:1. */}
                      <form
                        className="p-1"
                        id="frm-example"
                        action={PRINT_BASE}
                      ...
                      {/* receipt-f-hs.php L147-155 — the fixed-bottom
                          ...
                          L234-240) opens the print route with the
                          selected csv as the [id] path segment. */}
                      {btn ? (
                        <div
                          className="btn-group"
