    ...
    <>
      <main className="mx-auto w-full max-w-[900px] px-4 py-6 space-y-5">
        ...
        <nav className="flex items-center gap-1.5 text-xs text-muted">
          ...
          <ChevronRight className="w-3 h-3" />
          <span className="text-foreground font-medium">ถอนเงิน</span>
        </nav>
        ...
        <div className="rounded-2xl border border-border bg-white dark:bg-surface p-5 shadow-sm">
          <div className="flex flex-wrap items-start justify-between gap-3">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-xl sm:text-2xl font-bold text-foreground">ถอนเงินจากกระเป๋าสตางค์</h1>
                <p className="text-xs text-muted mt-0.5">โอนยอดเงินสดจาก Pacred เข้าบัญชีธนาคารของคุณ</p>
              </div>
            </div>
            <Link
              href="/wallet/history"
        ...
        <div className="rounded-2xl border-2 border-amber-300/40 bg-gradient-to-br from-amber-400 to-orange-500 text-white p-5 shadow-md overflow-hidden">
          <div className="flex items-start justify-between gap-4">
            <div className="min-w-0 flex-1">
              ...
              <p className="text-xs opacity-80 mt-0.5">ยอดที่สามารถถอนได้ (บาท)</p>
        ...
        <div className="rounded-2xl border border-amber-200 bg-amber-50/50 p-5">
          <h3 className="font-bold text-amber-800 flex items-center gap-2">
            ⚠️ เงื่อนไขการถอนเงินที่ต้องทราบ
          </h3>
          <ol className="mt-3 text-sm text-amber-900 space-y-1.5 list-decimal pl-5">
            <li>สามารถถอนเงินได้เมื่อท่านเคยชำระค่าฝากสั่งซื้อ หรือฝากนำเข้ากับ Pacred มาก่อน</li>
            <li>การถอนเงินต้องแนบเอกสาร <b>บัตรประจำตัวประชาชน</b> และ <b>หน้าสมุดบัญชีธนาคาร</b> (ส่งผ่านเซลล์ผู้ดูแลหลังกรอกฟอร์ม)</li>
            <li>ยอดถอนเงินขั้นต่ำ <b>25 บาท</b> ต่อครั้ง</li>
            <li>หากยอดถอนน้อยกว่า <b>500 บาท</b> มีค่าบริการ <b>25 บาท/ครั้ง</b></li>
            <li>ระยะเวลาดำเนินการ <b>7-10 วันทำการ</b> (ไม่รวมวันหยุดนักขัตฤกษ์และวันอาทิตย์)</li>
