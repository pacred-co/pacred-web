...
const TERMS = [
  ...
  },
  {
    code: "FOB",
    name: "Free On Board",
    desc: "ผู้ขายส่งของถึงท่าเรือต้นทาง · ลูกค้าจ่ายค่าขนส่ง+ภาษี+เคลียร์ปลายทาง — Pacred ดูแลส่วนนี้ครบ",
    icon: Anchor,
  },
  {
    code: "EXW",
  ...
  },
  {
    ...
    desc: "ผู้ขายจ่ายขนส่ง+ประกันถึงท่าเรือไทย · Pacred ดูแลเคลียร์ภาษี + ส่งต่อในประเทศ",
    icon: Ship,
  },
];
...
const STEPS = [
  ...
  { num: "04", icon: Ship, title: "ขนส่งทางเรือ", desc: "Booking สายเรือ · จัด container · ติดตามจนถึงท่าเรือไทย" },
...
const WHY = [
  ...
  { icon: Award, title: "ทีมหน้างานจริง", desc: "ประจำท่าเรือ + คลัง + พิธีการ" },
];
...
const FAQ_ITEMS = [
  ...
  },
  {
    ...
    a: "ค่าขนส่งทางเรือ FCL จีน-ไทย ขึ้นกับ ท่าเรือต้นทาง (เซินเจิ้น/เซี่ยงไฮ้/หนิงโป/อี้อู) · ท่าเรือปลายทาง (แหลมฉบัง/คลองเตย) · ขนาดตู้ · ฤดูกาล (peak/off-peak) ทีม quote ให้ก่อนยืนยันทุกครั้ง รวม Total Landed Cost ครบ",
  },
  {
    q: "ใช้เวลากี่วัน?",
    a: "FCL จีน-ไทย ทางเรือ — Transit time 8-12 วัน (จากท่าเรือต้นทางถึงแหลมฉบัง) + 2-3 วันสำหรับขนส่งโรงงาน-ท่า + 2-3 วันสำหรับเคลียร์ภาษี + ส่งใน TH รวม ~15-20 วัน",
  },
  {
    q: "Term ไหนเหมาะกับ FCL?",
    a: "DDP ยอดนิยมที่สุด — Pacred จัดการทั้งหมด ลูกค้ารับของถึงประตู · FOB ก็ใช้ได้บ่อย ผู้ขายส่งถึงท่าเรือจีน Pacred ลำเลียงต่อ · EXW เหมาะกับลูกค้าที่ต้องการคุมจุดรับของจากโรงงาน · CIF เหมาะกับซัพพลายเออร์ที่จ่ายขนส่ง+ประกันถึงไทยอยู่แล้ว",
  },
  {
        ...
        <section className="relative pt-3 md:pt-5 pb-2 md:pb-4">
          <div className="relative mx-auto w-full max-w-[1140px] px-4 md:px-5">
            ...
            <h2 className="mt-2 md:mt-3 text-[13px] md:text-[16px] leading-[1.6] font-medium text-muted max-w-[920px]">
              สำหรับ order ปริมาณมาก — เหมาตู้คุ้มที่สุด · รับของจากโรงงานจีน · ลำเลียงตู้ตรงสู่ท่าเรือไทย · เคลียร์ภาษี · ส่งถึงประตู <span className="text-primary-600/80 font-bold">รองรับ DDP / EXW / FOB / CIF</span>
            </h2>
