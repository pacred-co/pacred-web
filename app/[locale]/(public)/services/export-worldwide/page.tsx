...
const TERMS = [
  ...
  { code: "FOB", name: "Free On Board", desc: "ผู้ขายส่งของถึงท่าเรือต้นทาง · ผู้ซื้อจ่ายค่าขนส่ง+เคลียร์ปลายทาง" },
  { code: "CFR", name: "Cost & Freight", desc: "ผู้ขายจ่ายค่าขนส่งถึงท่าเรือปลายทาง · ผู้ซื้อรับผิดชอบประกัน+เคลียร์" },
  { code: "CIF", name: "Cost · Insurance · Freight", desc: "ผู้ขายจ่ายขนส่ง+ประกันถึงท่าเรือปลายทาง · ผู้ซื้อเคลียร์ปลายทาง" },
...
const STEPS = [
  ...
  { num: "04", icon: PackageSearch, title: "Pickup + บรรจุ", desc: "รับของจากโรงงาน · บรรจุมาตรฐานส่งออก · ลำเลียงสู่ท่า" },
...
const FAQ_ITEMS = [
  ...
  },
  {
    ...
    a: "ขึ้นกับข้อตกลงกับลูกค้าปลายทาง — FOB / CFR / CIF ยอดนิยมสำหรับ Sea Freight เพราะแยกความรับผิดชอบที่ท่าเรือต้นทาง · DDP เหมาะสำหรับลูกค้าปลายทางที่ต้องการรับของถึงประตูไม่ยุ่งภาษี · EXW ใช้เมื่อผู้ซื้อต้องการคุมการขนส่งทั้งหมดเอง ทีม Pacred ให้คำปรึกษาเลือก Incoterm ตามเงื่อนไขจริง",
  },
  {
