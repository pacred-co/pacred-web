  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        a: "DDP (Delivered Duty Paid) = ราคาที่จ่ายรวมทุกอย่างจนถึงปลายทางไทย รวมภาษี ลูกค้าไม่ต้องเคลียร์เอง. EXW = รับสินค้าหน้าโรงงาน. FOB = รับที่ท่าเรือต้นทาง. CIF = รับที่ท่าเรือปลายทาง รวมประกัน",
      },
    ],
  },
  {
    ...
    items: [
      ...
      {
        q: "เติมเงินเข้ากระเป๋า (Wallet) ทำยังไง?",
    ...
    items: [
      {
        ...
        a: "เคลียร์ได้ครบทุกด่านในไทย: สุวรรณภูมิ · ดอนเมือง · ท่าเรือคลองเตย · แหลมฉบัง · ICD ลาดกระบัง · ไปรษณีย์หลักสี่ · มุกดาหาร · หนองคาย · อรัญประเทศ · แม่สาย. ส่งเอกสารมาทาง LINE — เริ่มเคลียร์ภายในชั่วโมง",
      },
      {
      ...
      {
        q: "อย./มอก./ใบอนุญาตอื่น — ขอเองได้ไหม หรือต้องใช้บริการ?",
        a: "Pacred ช่วยขอใบอนุญาตทุกประเภทจากหน่วยงานที่เกี่ยวข้อง (อย./มอก./กสทช./เกษตร/ประมง) ใช้เวลา 1–5 วันทำการขึ้นกับหน่วยงาน — ไม่ต้องเดินเอกสารเอง",
      },
    ],
  },
  {
